...
<pre><code>git submodule add git://github.com/josegonzalez/upload.git Plugin/Upload
git submodule init
...
Note: if do you want to use GD instead of imagick just set the thumbnailMethod attribute in your model. Ex: 'thumbnailMethod'	=> 'php', by default it will be 'thumbnailMethod'	=> 'imagick'.
